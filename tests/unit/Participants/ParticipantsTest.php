...
class ParticipantsTest extends TestCase
{
    ...
    public function testGet(): ParticipantDTO
    {
        ...
        $this->assertEmpty($responseDTO->getMethod()->getPreviousPage());
        $this->assertArrayHasKey('sport_id', $responseDTO->getMethod()->getParameters());
        $this->assertEquals(5, $responseDTO->getMethod()->getParameters()['sport_id']);
        $this->assertArrayHasKey('participant_id', $responseDTO->getMethod()->getParameters());
        $this->assertEquals($participantId, $responseDTO->getMethod()->getParameters()['participant_id']);
