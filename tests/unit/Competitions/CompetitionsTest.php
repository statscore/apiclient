...
class CompetitionsTest extends TestCase
{
    ...
    public function testGet(): CompetitionDTO
    {
        ...
        $this->assertEmpty($responseDTO->getMethod()->getPreviousPage());
        $this->assertArrayHasKey(Api::QUERY_CLIENT_ID, $responseDTO->getMethod()->getParameters());
        $this->assertArrayHasKey(Api::QUERY_COMPETITION_ID, $responseDTO->getMethod()->getParameters());
        $this->assertEquals($id, $responseDTO->getMethod()->getParameters()[Api::QUERY_COMPETITION_ID]);
